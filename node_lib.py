...
Reusable Neural-ODE building blocks, extracted verbatim from
node_implementation.ipynb (originally adapted from
https://github.com/msurtsukov/neural-ode).

Import this from any notebook in the same folder instead of
redefining/re-running these classes each time, e.g.:

    from node_lib import ODEF, ODEAdjoint, NeuralODE, ode_solve
"""
